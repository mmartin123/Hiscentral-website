...
public partial class admin_UsageReportAllNetworks : System.Web.UI.Page {
    ...
    protected void Page_Load(object sender, EventArgs e) {
        var s1 = DataAccess_Logging.GetMultiColumnStat1_ByMonth(String.Empty);
        var s2 = DataAccess_Logging.GetMultiColumnStat2_ByMonth(String.Empty);
       // var s3 = DataAccess_Logging.GetMultiColumnStat3_ByMonth(String.Empty);
        var s4 = DataAccess_Logging.GetMultiColumnStat4_ByMonth(String.Empty);
        ...
        csvList.Add(new CSVModel {
            ...
            Stat4_StatOrg = ".ORG Values per Day",

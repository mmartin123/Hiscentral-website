...
<body>
    ...
    <div>
      ...
      <asp:Button ID="btnYes" runat="server" OnClick="btnYes_Click" OnClientClick="return fnConfirm();" Style="z-index: 101;
      ...
      &nbsp;
      <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" OnClientClick="return fnConfirm();" Style="z-index: 105;
...
<script type="text/javascript">
    function fnConfirm() {
        var networkName = '<%=NetworkName.ToString()%>';
        var networkId = '<%=id.ToString()%>';
        var Result = confirm('Are you sure you want to delete " ' + networkName + ' " Network , Network Id = " ' + networkId + ' " ?');
        return Result;
    };

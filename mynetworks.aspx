    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:HyperLinkField runat="server" Text="Test" NavigateUrl="~/Test.aspx" />
                ...
                <asp:BoundField DataField="NetworkID" HeaderText="NetworkID" Visible="false" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CentralHISConnectionString %>"
            SelectCommand="SELECT [NetworkID], [username], [NetworkName], [ServiceWSDL], [ContactName], [Organization], [website] FROM [HISNetworks]" OnSelected="SqlDataSource1_Selected" OnInit="SqlDataSource1_Init" OnSelecting="SqlDataSource1_Selecting" 
        ...
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Style="z-index: 102;
            left: 22px; color:red; position: absolute; top: 160px" Text="You do not yet have any registered data services." Width="600px"></asp:Label>

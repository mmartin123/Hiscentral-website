<%@ Page Language="C#" AutoEventWireup="true" CodeFile="uploadIcon.aspx.cs" Inherits="uploadIcon" %>
    ...
    <div>
      ...
      <asp:Button ID="btmOrgUpload" runat="server" Text="Upload" OnClick="uploadOrgIconButton_Click" style="z-index: 100; left: 355px; position: absolute; top: 231px" Width="79px" />
        <asp:Image ID="imgOrgIcon" runat="server" Height="150px" Style="z-index: 101; left: 461px;
            position: absolute; top: 162px" Width="150px" Visible="False" />
        <asp:Button ID="Button1" runat="server" Style="z-index: 102; left: 33px; position: absolute;
            top: 491px" Text="<< Back" OnClick="Button1_Click" Width="61px" />
        ...
        <asp:Image ID="imgMapIcon" runat="server" Height="16px" Style="z-index: 106; left: 470px;
            position: absolute; top: 384px" Width="16px" Visible="False" />

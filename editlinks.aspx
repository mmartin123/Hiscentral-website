<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editlinks.aspx.cs" Inherits="editlinks" %>
...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="Silver" Height="118px" Style="z-index: 101;
            ...
            ErrorMessage="URL Required" Style="width: 200px; z-index: 112; left: 560px; position: absolute;
            ...
            ErrorMessage="Citation Required" Style="width: 200px; z-index: 112; left: 560px; position: absolute;

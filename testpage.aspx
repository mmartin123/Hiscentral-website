...
<body>
    ...
    <div>
        ...
        <asp:Button ID="btnGetSiteInfo" runat="server" OnClientClick="displayLoadingImage();" OnClick="btnGetSiteInfo_Click" Style="z-index: 103;
            left: 537px; position: absolute; top: 11px" Text="Get Site info" Width="97px" Height="24px" Font-Size="14px" />
         <img src="Images/Waiting.gif" alt="Please Wait..." name="imgLoading" id="imgLoading" style="Z-INDEX: 101; LEFT: 424px; VISIBILITY: hidden; POSITION: absolute; TOP: 240px"/>
            &nbsp; &nbsp;
            &nbsp; &nbsp;<br />
            &nbsp;
        ...
        <asp:Panel ID="pnl1" runat="server" Height="48px" Style="font-weight: bold; z-index: 101;
            ...
            &nbsp;
            &nbsp; &nbsp;
            <asp:Button ID="btnConnect2" OnClientClick="displayLoadingImage();" runat="server" OnClick="btnConnect_Click" Style="z-index: 102;
                left: 536px; position: absolute; top: 0px" Text="Get Sites" Width="100px" Font-Size="14px" />
<img src="Images/Waiting.gif" alt="Please Wait..." name="imgLoading" id="imgLoading1" style="Z-INDEX: 101; LEFT: 424px; VISIBILITY: hidden; POSITION: fixed; TOP: 240px"/>
        ...
        <asp:Panel ID="pnl4" runat="server" Height="260px" Style="font-weight: bold; z-index: 103;
            left: 22px; color: black; text-indent: 10px; position: absolute; top: 460px;
        ...
        <asp:Calendar ID="calStart" runat="server" BackColor="White" BorderColor="#999999"
            ...
            top: 7px;" Width="125px" OnSelectionChanged="calStart_SelectionChanged">
        ...
        <asp:Calendar ID="calEnd" runat="server" BackColor="White" BorderColor="#999999"
            CellPadding="3" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="10px"
            ForeColor="Black" Height="106px" Style="z-index: 101; left: 350px; position: absolute;
            top: 9px" Width="125px" OnSelectionChanged="calEnd_SelectionChanged">
            <SelectedDayStyle BackColor="#666666" Font-Bold="True" ForeColor="White" />
            <TodayDayStyle BackColor="Gainsboro" ForeColor="Black" />
            <SelectorStyle BackColor="#CCCCCC" />
            <WeekendDayStyle BackColor="White" />
            ...
            <div style="width:140px; margin-left:20px; margin-top:130px">
        <asp:CheckBox ID="chkStart" runat="server"  Text="Use Start Date" Font-Size="14px" /> &nbsp;    
            <asp:TextBox ID="txtStart" runat="server"  Width="104px"></asp:TextBox> &nbsp; 
             <asp:Button ID="btnStart" runat="server"  Height="24px" OnClick="btnStart_Click" Width="111px" Text="Set Date" Font-Size="14px" />  
                </div> 
            <div style="width:140px; margin-top:-80px; margin-left:360px">
        <asp:CheckBox ID="chkEnd" runat="server" Text="Use End Date" Font-Size="14px" />           
            &nbsp;        
        <asp:TextBox ID="txtEnd" runat="server"  Width="110px"></asp:TextBox>        
        <asp:Button ID="btnEnd" runat="server"  Height="24px" OnClick="btnEnd_Click" Width="116px" Text="Set Date" Font-Size="14px" />
            &nbsp; &nbsp;</div>
        </asp:Panel>
        &nbsp; &nbsp;&nbsp;
        <div style="z-index: 115; left: 20px; overflow:auto; width:887px; position: absolute; top: 750px; height:100px">
        ...
        <asp:Label ID="Label5" runat="server" Style="z-index: 104; left: 21px; position: absolute;
            top: 720px" Text="Raw XML Response:"></asp:Label>
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        ...
        &nbsp; &nbsp; &nbsp;&nbsp;
        <asp:Button ID="btnGetValues" OnClientClick="displayLoadingImage();" runat="server" OnClick="btnGetValues_Click" Style="z-index: 106;
            left: 681px; position: absolute; top: 358px" Text="Get Values" Width="226px" />
     <img src="Images/Waiting.gif" alt="Please Wait..." name="imgLoading" id="imageloading3" style="Z-INDEX: 101; LEFT: 424px; VISIBILITY: hidden; POSITION: absolute; TOP: 240px"/>

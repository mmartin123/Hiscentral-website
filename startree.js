...
var strapplet = 
  ...
  applets  //'<applet name="TreeApplet" codebase="http://hiscentral3.cuahsi.org/applets" code="STApplet.class" archive="StarTree30c.jar" WIDTH="'+mWidth+' px" HEIGHT="'+(mHeight-130)+' px" MAYSCRIPT>'+
    '<applet name="TreeApplet" codebase="applets" code="STApplet.class" archive="StarTree30c.jar" WIDTH="'+mWidth+' px" HEIGHT="'+(mHeight-130)+' px" MAYSCRIPT>'+

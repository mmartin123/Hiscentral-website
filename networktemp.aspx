...
<body>
    ...
    <div></div>    
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CentralHISConnectionString %>"
            SelectCommand="SELECT username, ServiceWSDL, ServiceAbs, NetworkName, ContactName, ContactEmail, ContactPhone, Organization, website, IsPublic, SupportsAllMethods, Citation, MapIconPath, OrgIconPath FROM HISNetworks WHERE (NetworkID = @NetworkID)" 
            ...
            UpdateCommand="UPDATE HISNetworks SET NetworkName= @NetworkName, ServiceWSDL =@ServiceWSDL, ServiceAbs =@ServiceAbs, ContactName =@ContactName, ContactEmail =@ContactEmail, ContactPhone =@ContactPhone, Organization =@Organization, website =@website WHERE [NetworkID] = @NetworkID">
            <SelectParameters>
        ...
        <div style="z-index: 100; left: 20px; width: 860px; position: absolute; top: 200px;">
            ...
            <EditItemTemplate>
              <div style="z-index: 100; left: 1px; width: 860px; position: absolute; top: 0px;
                ...
                <asp:TextBox ID="CitationTextBox" runat="server" Text='<%# Bind("citation") %>' style="z-index: 108; left: 439px; position: absolute; top: 223px" Height="85px" Width="363px" TabIndex="3" TextMode="MultiLine"></asp:TextBox>
                 ...
                 <asp:Label ID="Label2" runat="server" Font-Bold="True" Style="z-index: 109; left: 19px;
                     position: absolute; top: 18px" Text="Network:" Font-Size="Larger" Width="106px"></asp:Label>
                 <asp:Label ID="Label6" runat="server" Font-Bold="True" Style="z-index: 110; left: 34px;
                     position: absolute; top: 36px" Text="Name:" Width="84px"></asp:Label>
                 <asp:Label ID="Label8" runat="server" Font-Bold="True" Style="z-index: 111; left: 34px;
                     position: absolute; top: 219px" Text="Name:" Width="116px"></asp:Label>
                 <asp:Label ID="Label9" runat="server" Font-Bold="True" Style="z-index: 112; left: 34px;
                     position: absolute; top: 263px" Text="Phone:"></asp:Label>
                 <asp:Label ID="Label10" runat="server" Font-Bold="True" Style="z-index: 113; left: 34px;
                     position: absolute; top: 242px" Text="Email:" Width="87px"></asp:Label>
                 <asp:Label ID="Label11" runat="server" Font-Bold="True" Style="z-index: 114; left: 34px;
                     position: absolute; top: 112px" Text="Organization:"></asp:Label>
                 <asp:Label ID="Label12" runat="server" Font-Bold="True" Style="z-index: 115; left: 34px;
                     position: absolute; top: 133px" Text="URL:"></asp:Label>
                 <asp:Label ID="Label7" runat="server" Font-Bold="True" Style="z-index: 116; left: 34px;
                     position: absolute; top: 56px" Text="Service WSDL:"></asp:Label>
                 <asp:Label ID="Label3" runat="server" Font-Bold="True" Style="z-index: 117; left: 446px;
                     position: absolute; top: 324px" Text="Abstract:" Font-Size="Larger"></asp:Label>
                 <asp:Label ID="Label4" runat="server" Font-Bold="True" Style="z-index: 118; left: 19px;
                     position: absolute; top: 190px" Text="Contact Info:" Font-Size="Larger" Width="125px"></asp:Label>
                 <asp:Label ID="Label5" runat="server" Font-Bold="True" Style="z-index: 119; left: 19px;
                ...
                <asp:LinkButton ID="UpdateButton" runat="server" CausesValidation="True" CommandName="Update"
                    Text="Update" style="z-index: 120; left: 48px; position: absolute; top: 428px; border-right: black thin solid; border-top: black thin solid; font-weight: bold; vertical-align: middle; border-left: black thin solid; color: blue; border-bottom: black thin solid; background-color: white; text-align: center; text-decoration: none;" Height="21px" Width="69px" TabIndex="8"></asp:LinkButton>
                <asp:LinkButton ID="UpdateCancelButton" runat="server" CausesValidation="False" CommandName="Cancel"
                    Text="Cancel" style="z-index: 121; left: 138px; position: absolute; top: 428px; border-right: black thin solid; border-top: black thin solid; font-weight: bold; vertical-align: middle; border-left: black thin solid; color: blue; border-bottom: black thin solid; background-color: white; text-align: center; text-decoration: none;" Height="21px" Width="69px" TabIndex="9"></asp:LinkButton>
                
                
                     <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="ContactEmailTextBox"
                         ErrorMessage="Invalid Email" Style="z-index: 122; left: 335px; position: absolute;
                     ...
                     <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="websiteLabel"
                         ErrorMessage="Invalid URL" Style="z-index: 123; left: 624px; position: absolute;
                     ...
                     <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="ContactPhoneTextBox"
                         ErrorMessage="Invalid Phone number" Height="43px" Style="z-index: 124; left: 335px;
                     ...
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="NetworkNameTextBox"
                         ErrorMessage="Required Field" Style="z-index: 125; left: 631px; position: absolute;
                     ...
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ServiceWSDLTextBox"
                         ErrorMessage="Required Field" Style="z-index: 126; left: 630px; position: absolute;
...
<asp:Label ID="hiddenUserName" runat="server" Font-Bold="True" Style="z-index: 120; left: 575px;
                     position: absolute; top: 5px" Text='<%# Bind("UserName") %>' Font-Size="Larger" Width="117px"></asp:Label>                                               
                
                <div style="z-index: 119; top:202px; left:341px; position:absolute; width:505px;
                     height: 262px; overflow:auto;">
                ...
                <asp:Label ID="ServiceWSDLLabel" runat="server" Text='<%# Bind("ServiceWSDL") %>' style="z-index: 100; left: 154px; position: absolute; top: 54px" Width="459px" Height="20px"></asp:Label>          
                ...
                <asp:Label ID="websiteLabel" runat="server" Text='<%# Bind("website") %>' style="z-index: 109; left: 151px; position: absolute; top: 131px" Height="20px" Width="461px"></asp:Label>
                <asp:Label ID="CitationLabel" runat="server" Text='<%# Bind("citation") %>' style="z-index: 108; left: 439px; position: absolute; top: 223px" Height="85px" Width="363px" TabIndex="3"></asp:Label>
                 ...
                 <asp:Label ID="Label7" runat="server" Font-Bold="True" Style="z-index: 117; left: 34px;
                     position: absolute; top: 56px" Text="Service WSDL:"></asp:Label>
                 <asp:Label ID="Label3" runat="server" Font-Bold="True" Style="z-index: 118; left: 342px;
                     position: absolute; top: 186px" Text="Abstract:" Font-Size="Larger"></asp:Label>
                 <asp:Label ID="Label4" runat="server" Font-Bold="True" Style="z-index: 119; left: 19px;
                     position: absolute; top: 190px" Text="Contact Info:" Font-Size="Larger" Width="125px"></asp:Label>
                 <asp:Label ID="Label5" runat="server" Font-Bold="True" Style="z-index: 120; left: 19px;
                     position: absolute; top: 92px" Text="Source Info:" Font-Size="Larger" Width="117px"></asp:Label>
                 
<% if (Page.User.Identity.Name == ((System.Data.DataRowView) this.FormView1.DataItem).Row[0].ToString()){ %>
                <asp:LinkButton ID="EditButton" runat="server" CausesValidation="False" CommandName="Edit"
                    Text="Edit" style="z-index: 120; left: 22px; position: absolute; top: 430px; border-right: black thin solid; border-top: black thin solid; font-weight: bold; border-left: black thin solid; color: blue; border-bottom: black thin solid; background-color: white; text-align: center; text-decoration: none;" Height="19px" Width="78px"></asp:LinkButton>
<% } %>
                </div>
            </ItemTemplate>
        </asp:FormView>
        ...
        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Large" Style="z-index: 102;
            left: 23px; position: absolute; top: 160px" Text="Network Details:" Width="225px"></asp:Label>

       ...
       <uc1:HeaderControl ID="HeaderControl1" runat="server" />
        ...
        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
            CellPadding="4" DataKeyNames="NetworkID" DataSourceID="SqlDataSource1" GridLines="None"
             Style="z-index: 100;
            left: 0px; position: absolute; top: 200px" OnRowCommand="GridView1_RowCommand" ForeColor="#333333" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AllowPaging="True" Font-Size="Small" PageSize="30">
            <FooterStyle BackColor="#5D7B9D" ForeColor="White" Font-Bold="True" />
            <Columns>
              <asp:HyperLinkField DataNavigateUrlFields="NetworkID" DataNavigateUrlFormatString="pub_network.aspx?n={0}"
                DataTextField="NetworkTitle" SortExpression="NetworkTitle" HeaderText="Data Service Title" />
              <asp:HyperLinkField DataNavigateUrlFields="NetworkID" DataNavigateUrlFormatString="pub_network.aspx?n={0}"
              ...
              <asp:BoundField DataField="ProjectStatus" HeaderText="Status" SortExpression="ProjectStatus" Visible="False" />

...
<body>
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            GridLines="Both" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Style="z-index: 100;
            left: 119px; position: absolute; top: 161px" DataKeyNames="NetworkID" BorderStyle="Solid">

...
FinalizeMapping:function(varID,conceptID,userName,succeededCallback, failedCallback, userContext) {
return this._invoke(Tagger.TaggerService.get_path(), 'FinalizeMapping',false,{varID:varID,conceptID:conceptID,userName:userName},succeededCallback,failedCallback,userContext); },
...
Tagger.TaggerService.set_timeout = function(value) { var e = Function._validateParams(arguments, [{name: 'timeout', type: Number}]); if (e) throw e; if (value < 0) { throw Error.argumentOutOfRange('value', value, Sys.Res.invalidTimeout); }
...
Tagger.TaggerService.set_path("/tagger/taggerservice.asmx");
...
Tagger.TaggerService.FinalizeMapping= function(varID,conceptID,userName,onSuccess,onFailed,userContext) {Tagger.TaggerService._staticInstance.FinalizeMapping(varID,conceptID,userName,onSuccess,onFailed,userContext); }

...
var strapplet = 
    ...
    //'<applet name="TreeApplet" code="STApplet.class" codebase="http://hiscentral3.cuahsi.org/applets" archive="StarTree30c.jar" WIDTH="' + mWidth + ' px" HEIGHT="' + (mHeight - 220) + ' px" MAYSCRIPT>' +
     '<applet name="TreeApplet" codebase="applets" code="STApplet.class" archive="StarTree30c.jar" WIDTH="100%" HEIGHT="600px"MAYSCRIPT>' +
    '<param name="cache_option" VALUE="No"/><param name="dataset" value="ontology_mar1.stc"/>' +
